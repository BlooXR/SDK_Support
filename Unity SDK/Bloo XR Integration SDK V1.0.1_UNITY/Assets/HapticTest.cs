...
public class HapticTest : MonoBehaviour
{
    ...
    //≤‚ ‘”“ ÷∆’Õ®’∂Ø
    private void testCustomStartHaptic()
    {
        SDKAPI.Instance.SetCustomDataSource(255, 0, 3000,4, 2000, (int)HandShankID.HANDSHANK_BOTH);
        SDKAPI.Instance.PrepareHaptic((int)HandShankID.HANDSHANK_BOTH);
        SDKAPI.Instance.StartHaptic((int)HandShankID.HANDSHANK_BOTH);
        Debug.Log("Bxr TestCustomStartHaptic have done");
    }
    //≤‚ ‘◊Û ÷HEŒƒº˛’∂Ø
